/**
 * Taken directly from node-cipher repo due to security issues
 * with dependancies and a 3 y/o repo.  Submitted a PR to address this. Will
 * update this repo to link directly to node-cipher when it's fixed again.
 */

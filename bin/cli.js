...
program
  ...
  .usage(`<encrypt|decrypt> [options]
  You simply place your secret files in your .gitignore file under the '# Secrets' comment.
  It produces secrets.encrypted which you can safely commit!`);
